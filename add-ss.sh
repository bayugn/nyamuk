...
clear
	...
	echo -e "×××××××××××××××××××××××××××××××××"
        ...
        echo -e "×××××××××××××××××××××××××××××××××"
	echo -e "ᗚ IP/Host • $IP"
	echo -e "ᗚ Password       • $user"
	echo -e "ᗚ Method         • aes-256-cfb"
	echo -e "ᗚ Expired On     • $exp"
	echo -e "ᗚ Port OBFS TLS  • $tls"
	echo -e "ᗚ Port OBFS HTTP • $http"
	echo -e "×××××××××××××××××××××××××××××××××"
	echo -e "ᗚ Link OBFS TLS  ๛ $linkss1"
	echo -e "×××××××××××××××××××××××××××××××××"
	echo -e "ᗚ Link OBFS HTTP ๛ $linkss2"
	echo -e "×××××××××××××××××××××××××××××××××"
