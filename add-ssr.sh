...
echo -e "ᗚ IP/Host • $IP"
echo -e "ᗚ Port          • ${ssr_port}"
echo -e "ᗚ Password      • ${ssr_password}"
echo -e "ᗚ Encryption    • ${ssr_method}"
echo -e "ᗚ Protocol      • ${Red_font_prefix}${ssr_protocol}"
echo -e "ᗚ Obfs          • ${Red_font_prefix}${ssr_obfs}"
echo -e "ᗚ Device limit  • ${ssr_protocol_param}"
echo -e "ᗚ Expired On    • ${exp} "
echo -e "××××××××××××××××××××××××××××××××××××××××××××××××××××××"
echo -e "ᗚ Link SSR ๛ ${ssr_link}"
echo -e "××××××××××××××××××××××××××××××××××××××××××××××××××××××"
